...
class App:
    ...
    def __init__(self, window, window_title, video_source=0):
        ...
        self.btn_start.configure(
            font=("Helvetica", 12),  # Text color when pressed
        ...
        self.btn_quit= tk.Button(window, text="Quit Program", command=quit)
        self.btn_quit.pack(side = tk.LEFT)
        self.btn_quit.configure(
            font=("Helvetica", 12),  # Text color when pressed
            padx=20,        # Horizontal padding
            pady=10,
            background='red'
...
class ElapsedTimeClock:
    def __init__(self, window):
        self.T= tk.Label(window, text = "00:00:00", font=("helvetica",20,"bold"), bg='red')
...
class CommandLineParse:
    def __init__(self):
        ...
        parser.add_argument("--type", nargs=1, default=["mp4"], type=str, help="To select the type of video")
        parser.add_argument("--res", nargs=1, default=["720p"], type=str, help="Resolution")
